  ...
  if (zip != null) {
    try {
      ...
      for (let i = 0; i < closestLocations.length; i++) {
        ...
        let shortStr = "";
        shortStr +=
          closestLocations[i][1].toString() + "))" + arr[0] + ":" + arr[1];
        string += shortStr + "..";
      }
      return string;
    } catch (err) {
...
export const selectHandlerFn = function (
  setQuery,
  setModel,
  setCalcButtons,
  setFind
...
export const locateDealershipsFn = function (
  setDealers,
  setCalcButtons,
  setSelect,
  selected,
...
export const calcButtonHandlerFn = function (
  setQuery,
  setMessages,
  setCalcButtons,
  setShowCalcButtons
...
export const changeFindFn = function (
  setFind,
  setSelect,
  setCalcButtons,
  selectHandler
